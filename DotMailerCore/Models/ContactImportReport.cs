...
{
	public class ContactImportReport
	{
		...
		public int IspComplaints { get; set; }

		public int MailBlocked { get; set; }

		public int DomainSuppressed { get; set; }

		public int PendingDoubleOptin { get; set; }
